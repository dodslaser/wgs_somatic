...
if normalid:
    rule insilico_coverage:
     ...
     rule insilico_coverage:
        ...
        run:
            os.makedirs(f'{workingdir}/{tumorid}/{wildcards.sname}/insilico', exist_ok=True)
            os.makedirs(f'{workingdir}/{tumorid}/{wildcards.sname}/insilico/{wildcards.insiliconame}', exist_ok=True)
